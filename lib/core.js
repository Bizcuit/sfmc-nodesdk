...
module.exports = {
	...
	createRetriveRequest: function(options){
		...
		if(options.filter){
			RetrieveRequestMsg.RetrieveRequest.Filter = options.filter;
			RetrieveRequestMsg.RetrieveRequest.Filter['@'] = {'xsi:type': 'SimpleFilterPart'};
		}
	...
	create: async function(options){
		...
		if(options.mid){
			createOptions.CreateOptions.ClientID = {
				ID: mid
			}
		}
	...
	retrieve: async function(options){
		...
		var retriveRequest   = this.createRetriveRequest(options);
		var message          = await this.execute('Retrieve', 'RetrieveRequestMsg', retriveRequest);
